...
public class FlashlightPickup : MonoBehaviour
{
    ...
    [Header("UI")]
    public GameObject energyBarUI;      // <--- ZMIANA: Przeciągnij tu sam obiekt SLIDER

    [Header("Światło Podświetlające (Scena)")]
    public GameObject highlightLight;        // Światło na ziemi

    [Header("Ustawienia Migania (Latarka Gracza)")]
    public GameObject flickerTarget;         // Co ma migać u gracza
    ...
    void Start()
    {
        ...
        // 2. Wyłączamy tylko Slider (celownik pozostanie widoczny, jeśli jest na Canvasie)
    ...
    void Interact()
    {
        // 1. Zgaszenie światła na ziemi
        if (highlightLight != null)
        {
            highlightLight.SetActive(false);
        }

        // 2. Włączenie latarki gracza
